...
@synthesize plotStatus,plotLegend,plotColor,plotData;
...
-(void)renderInLayer:(CPTGraphHostingView *)layerHostingView withTheme:(CPTTheme *)theme
{
    ...
    NSNumber *max = [plotData valueForKeyPath:@"@max.intValue"];
	...
	barPlotSpace.yRange = [CPTPlotRange plotRangeWithLocation:CPTDecimalFromFloat(0.0f) length:CPTDecimalFromFloat(maxFloat)];
	...
	whiteTextStyle.fontSize =  bounds.size.height / 50.0f;
...
{
	CPTColor *color = [plotColor objectAtIndex:index];
